...
const NavigationBar = () => {
  ...
  return (
    <Navbar style={{ backgroundColor: '#1a1a1a', transform: navHidden ? 'translateY(-100%)' : 'translateY(0)', transition: 'transform 0.25s ease', padding: '0', height: isMobile ? '52px' : '52px' }} variant="dark" sticky="top">
