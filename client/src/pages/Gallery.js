              ...
              <Col xl={4} lg={6} md={6} sm={12} key={image.id} className="mb-4" style={{ alignSelf: 'flex-start' }}>
                ...
                >
                  ...
                  <div style={{position: 'relative', flexShrink: 0}}>
                    <img
                      src={image.image_url.startsWith('http') ? image.image_url : `${window.location.origin}${image.image_url}`}
      ...
      >
        <Modal.Body style={{
          ...
          {selectedImage && (
            <>
              <img
                src={selectedImage.image_url.startsWith('http') ? selectedImage.image_url : `${window.location.origin}${selectedImage.image_url}`}
