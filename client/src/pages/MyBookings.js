          ...
          <div style={{
            ...
            <Modal.Body style={{
              ...
              <div style={{textAlign: 'center'}}>
                <div style={{
                  ...
                  <span>Rating</span>
                  <span style={{ color: 'rgba(255, 255, 255, 0.85)' }}>{feedbackRating}/5</span>
                </div>
                <div style={{
                  display: 'flex',
                  justifyContent: 'center',
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    <button
                      ...
                      style={{
                        background: star <= feedbackRating ? 'rgba(255, 255, 255, 0.18)' : 'rgba(255, 255, 255, 0.08)',
                        border: star <= feedbackRating ? '1px solid rgba(255, 255, 255, 0.65)' : '1px solid rgba(255, 255, 255, 0.12)',
                        borderRadius: '50%',
                        width: '34px',
                        height: '34px',
                        display: 'flex',
                        ...
                        justifyContent: 'center',
                        fontSize: '1rem',
                        color: star <= feedbackRating ? '#ffffff' : 'rgba(255, 255, 255, 0.5)',
                        cursor: 'pointer',
                        transition: 'all 0.2s ease'
                      }}
                    >
            ...
            <Modal.Footer style={{
              ...
              <Button
                ...
                onMouseEnter={(e) => {
                  e.target.style.transform = 'translateY(-2px)';
                  e.target.style.boxShadow = '0 14px 28px rgba(17, 24, 39, 0.35)';
                }}
                onMouseLeave={(e) => {
                  e.target.style.transform = 'translateY(0)';
                  e.target.style.boxShadow = '0 10px 24px rgba(17, 24, 39, 0.3)';
                }}
