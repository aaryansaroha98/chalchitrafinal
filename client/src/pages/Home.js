    ...
    <div className="bg-void" style={{minHeight: '100vh', position: 'relative', overflow: 'hidden'}}>
      ...
      className="video-section">
        ...
        {settings.hero_background_video && (
          ...
          >
            <source src={settings.hero_background_video.startsWith('http') ? settings.hero_background_video : `${window.location.origin}${settings.hero_background_video}`} type="video/mp4" />
          </video>
        )}
        ...
        {settings.hero_background_image && !settings.hero_background_video && (
          <div
            style={{
              ...
              width: '100%',
              height: '100%',
              backgroundImage: `url(${settings.hero_background_image.startsWith('http') ? settings.hero_background_image : `${window.location.origin}${settings.hero_background_image}`})`,
            ...
            <Row className="align-items-center about-row">
              ...
              <Col lg={4} md={5} className="text-center about-logo-wrap">
                <img
                  ...
                  src={settings.about_image ? (settings.about_image.startsWith('http') ? settings.about_image : `${window.location.origin}${settings.about_image}`) : '/newlogo.png'}
                  alt="Chalchitra Logo"
                  style={{
                    maxWidth: '300px',
                    width: '100%',
